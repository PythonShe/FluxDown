const en = {
  ...
  "dl.extensionDesc": "Intercept browser downloads and send them to FluxDown. Supports Chrome and Firefox. The Firefox extension is now officially listed on the Add-ons Store.",
  "dl.extensionFirefox": "Firefox Add-ons Store",
  "dl.extensionOffline": "Offline Package",
  "dl.extensionOtherNote": "Other browsers pending store review — use the offline package for now",
